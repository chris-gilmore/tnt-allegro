...
static void FUN_027BF0_80061a3c_tenliner_allocs_heap(ImageParams *dest, ImageParams *src) {
  ...
  if (src->img.id != 0) {
    dest->img.data = al_load_bitmap(config_setting_get_string_elem(images, src->img.id));
  }
}
...
void FUN_027BF0_check_music_settings_and_play(s32 screen) {
  ...
  if (D_800CFED4 == 1) {
    ...
    case 0:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(9, &g_songPlayer, 1);
    ...
    case 1:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(10, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
      } else if (sp1C < 16) {
        Audio_80084e20_twentyliner(sp1C, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
    ...
    case 2:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(11, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
      } else if (sp1C < 16) {
        Audio_80084e20_twentyliner(sp1C, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
    ...
    case 3:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(12, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
      } else if (sp1C < 16) {
        Audio_80084e20_twentyliner(sp1C, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
    ...
    case 4:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(13, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
      } else if (sp1C < 16) {
        Audio_80084e20_twentyliner(sp1C, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
    ...
    case 5:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(14, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
      } else if (sp1C < 16) {
        Audio_80084e20_twentyliner(sp1C, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
    ...
    case 6:
      if (sp1C == 0xFE) {
        Audio_80084e20_twentyliner(15, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
      } else if (sp1C < 16) {
        Audio_80084e20_twentyliner(sp1C, &g_songPlayer, 1);
        Audio2_GFXDone_SendPlayMessage(&g_songPlayer);
...
static void FUN_027BF0_8006307c_sixliner(ImageParams *imageParams) {
  if (imageParams->img.data != NULL) {
    al_destroy_bitmap(imageParams->img.data);
