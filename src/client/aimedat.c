...
static void func_800733F0(UnkStruct_112 *arg0) {
  ...
  */
  ...
  for (i = 0; i < g_playercount; i++) {
    ...
    */
    al_draw_filled_rectangle(sp10.x, sp10.y, sp10.x + 80, sp10.y + 2, al_premul_rgba(arg0->color[i].red, arg0->color[i].green, arg0->color[i].blue, arg0->color[i].alpha));
  }
...
void AimedAt_Init(void) {
  ...
  D_8011FC90 = al_load_bitmap(config_setting_get_string_elem(images, IMG_INDICATOR));
}

void AimedAt_Deinit(void) {
  al_destroy_bitmap(D_8011FC90);
}
