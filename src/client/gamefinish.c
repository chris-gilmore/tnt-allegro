...
static void   gamefinish_80052FC8_eightliner(UnkStruct_20 *, s32);
...
static void gamefinish_c_line_127(UnkStruct_7 *arg0, s32 gf_type) {
  ...
  arg0->image_loc.x = arg0->center_of_board.x - (al_get_bitmap_width(arg0->image) >> 1);
  arg0->image_loc.y = arg0->center_of_board.y - (al_get_bitmap_height(arg0->image) >> 1);
...
static void gamefinish_80052FC8_eightliner(UnkStruct_20 *arg0, s32 arg1) {
  if (arg0->unk38) {
    return;
  }
...
void gamefinish_800534A4_fiveliner(void) {
  al_destroy_bitmap(D_800CFF88);
  D_800CFF88 = NULL;
  al_destroy_bitmap(D_800CFF88);
  D_800CFF80 = NULL;
  al_destroy_bitmap(D_800CFF84);
  D_800CFF84 = NULL;
}
