...
static void func_80073D70(UnkStruct_29 *arg0) {
  ...
  gDPPipeSync(gdl++);
  */
  al_draw_filled_rectangle(sp48.x, sp48.y, sp48.x + 100, sp48.y + 2, al_premul_rgba(arg0->unk2, arg0->unk4, arg0->unk6, arg0->unk8));
  al_draw_filled_rectangle(sp48.x - 3, sp48.y - 200, sp48.x, sp48.y + 3, al_premul_rgba(arg0->unk2, arg0->unk4, arg0->unk6, arg0->unk8));
  al_draw_filled_rectangle(sp48.x + 100, sp48.y - 200, sp48.x + 103, sp48.y + 3, al_premul_rgba(arg0->unk2, arg0->unk4, arg0->unk6, arg0->unk8));
...
static void func_80074024(UnkStruct_29 *arg0) {
  ...
  gDPPipeSync(gdl++);
  */
  al_draw_filled_rectangle(sp50.x - 3, sp50.y - 160, sp50.x, sp50.y + 3, al_premul_rgba(arg0->unk2, arg0->unk4, arg0->unk6, arg0->unk8));
  al_draw_filled_rectangle(sp50.x + 80, sp50.y - 160, sp50.x + 83, sp50.y + 3, al_premul_rgba(arg0->unk2, arg0->unk4, arg0->unk6, arg0->unk8));

  al_draw_filled_rectangle(sp50.x, sp50.y - 160, sp50.x + 80, sp50.y, al_premul_rgba(arg0->unkA, arg0->unkC, arg0->unkE, arg0->unk10));
