...
static void calls_game_deinit(void) {
  ...
  D_8011F250 = al_create_bitmap(400, 300);
  /*
  ((u8 *) D_8011F250)[0] = 1;
  ...
  */
  ...
  al_set_target_bitmap(D_8011F250);
  ...
  D_8011F240 = al_load_bitmap(config_setting_get_string_elem(images, IMG_INVISIBLE_TROPHY));
  D_8011F258 = al_load_bitmap(config_setting_get_string_elem(images, IMG_RECTANGLE));
...
static void FUN_80055704_threeliner(void) {
  ...
  al_destroy_bitmap(D_8011F258);
  al_destroy_bitmap(D_8011F240);
  func_80090A44();
}
