    ...
    if (TRUE) {
      ...
      case 1:
        ...
        */
        ...
        al_draw_filled_rectangle(offset + scale * var_s6->unk0[0].p.x, offset + scale * var_s6->unk0[0].p.y, offset + scale * var_s6->unk0[3].p.x, offset + scale * var_s6->unk0[3].p.y, al_map_rgba(arg0->unk4.diffuse_red >> 4, arg0->unk4.diffuse_green >> 4, arg0->unk4.diffuse_blue >> 4, alpha));
      ...
      case 2:
        ...
        */
        ...
        /*
        printf("var_s6->unk0[0].p.x = %d\n", var_s6->unk0[0].p.x);
        printf("var_s6->unk0[0].p.y = %d\n", var_s6->unk0[0].p.y);
        printf("var_s6->unk0[3].p.x = %d\n", var_s6->unk0[3].p.x);
        printf("var_s6->unk0[3].p.y = %d\n", var_s6->unk0[3].p.y);
        */

        //al_draw_filled_triangle(offset + scale * var_s6->unk0[0].p.x, offset + scale * var_s6->unk0[0].p.y, offset + scale * var_s6->unk0[1].p.x, offset + scale * var_s6->unk0[1].p.y, offset + scale * var_s6->unk0[2].p.x, offset + scale * var_s6->unk0[2].p.y, al_map_rgba(0x0, 0x0, 0x0, alpha));
        al_draw_filled_triangle(offset + scale * var_s6->unk0[0].p.x, offset + scale * var_s6->unk0[0].p.y, offset + scale * var_s6->unk0[1].p.x, offset + scale * var_s6->unk0[1].p.y, offset + scale * var_s6->unk0[2].p.x, offset + scale * var_s6->unk0[2].p.y, al_map_rgba(arg0->unk4.diffuse_red >> 4, arg0->unk4.diffuse_green >> 4, arg0->unk4.diffuse_blue >> 4, alpha));
        al_draw_filled_triangle(offset + scale * var_s6->unk0[1].p.x, offset + scale * var_s6->unk0[1].p.y, offset + scale * var_s6->unk0[3].p.x, offset + scale * var_s6->unk0[3].p.y, offset + scale * var_s6->unk0[2].p.x, offset + scale * var_s6->unk0[2].p.y, al_map_rgba(arg0->unk4.diffuse_red >> 4, arg0->unk4.diffuse_green >> 4, arg0->unk4.diffuse_blue >> 4, alpha));
